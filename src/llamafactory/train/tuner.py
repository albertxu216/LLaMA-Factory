...
from .callbacks import LogCallback, StepJSONLoggerCallback, PissaConvertCallback, ReporterCallback
...
def _training_function(config: dict[str, Any]) -> None:
    ...
    callbacks.append(StepJSONLoggerCallback(training_args.output_dir))
